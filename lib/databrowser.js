...
exports.save = function(params, callback) {
  console.log(new Date() + ' - starting database save - process.env.FH_DB_PERAPP = ' + process.env.FH_DB_PERAPP);
  ...
  var hasDirectConnUrl = !_.isUndefined(process.env.FH_DB_PERAPP);
...
exports.disconnectDB = function(cb) {
  ...
  if(_.isUndefined(process.env.FH_DB_PERAPP)) {
